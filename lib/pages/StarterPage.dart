      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image:AssetImage('assets/foodphotos/SP.jpg'),
              fit: BoxFit.cover ,
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child:Column(
              ...
              children: <Widget>[
               FadeAnimation(0.5, Text('Taking order for delivery',style: TextStyle(
                  color: Colors.white,
                  fontSize: 50.0,
                ...
                FadeAnimation(0.9,Text('See Restaurents available \n by adding your location.',style: TextStyle(
                  color: Colors.white,
                  height: 1.4,
                  fontSize: 18.0,
                  fontWeight: FontWeight.bold,
